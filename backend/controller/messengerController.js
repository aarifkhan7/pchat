...
//    console.log("in messengercontroller imagename is2"+imageName);
   ...
   imageName=imageName[0].replace(/\s/g, "");
   reseverId=reseverId[0];



   const newPath=url.fileURLToPath(new URL(`../../frontend/public/image/${imageName[0]}`, import.meta.url));    //suppose this image is present in the image folder now it is creating path for that image
...
//  In this way image has been stored in our db. 
   files.image[0].originalFilename=imageName[0].replace(/\s/g, "");
